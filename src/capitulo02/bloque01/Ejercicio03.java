...
public class Ejercicio03 {
	...
	public static void main(String[] args) {
		...
		if (x >= y && x >= z && x >= a && x >= b) {
			System.out.println("El valor más alto es: " + x);
		}

		else {

			if (y >= x && y >= z && y >= a && y >= b) {
				System.out.println("El valor más alto es: " + y);
			} else {

				if (z >= x && z >= y && z >= a && z >= b) {
					System.out.println("El valor más alto es: " + z);
				} else {

					if (a >= y && a >= z && a >= x && a >= b) {
						System.out.println("El valor más alto es: " + a);
					} else {

						if (b >= y && b >= z && b >= a && b >= x) {
							System.out.println("El valor más alto es: " + b);
						} 
					}
				}
			}
