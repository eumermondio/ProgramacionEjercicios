...
public class PanelAInsertarEnJDialog extends JPanel {
	...
	public PanelAInsertarEnJDialog() {
		...
		btnNewButton.setIcon(new ImageIcon(PanelAInsertarEnJDialog.class.getResource("/capitulo08/Ejercicio02/res/gotostart.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(PanelAInsertarEnJDialog.class.getResource("/capitulo08/Ejercicio02/res/previous.png")));
		...
		btnNewButton_2.setIcon(new ImageIcon(PanelAInsertarEnJDialog.class.getResource("/capitulo08/Ejercicio02/res/next.png")));
		...
		btnNewButton_3.setIcon(new ImageIcon(PanelAInsertarEnJDialog.class.getResource("/capitulo08/Ejercicio02/res/gotoend.png")));
